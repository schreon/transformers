...
from transformers.models.h_transformer.reversible import ReversibleSequence, SequentialSequence
...
class HTransformer1D(nn.Module):
    def __init__(
        ...
        for ind in range(depth):
            attn = attn_class(dim, dim_head=dim_head, heads=heads, block_size=block_size, pos_emb=self.pos_emb,
                              **attn_kwargs)
