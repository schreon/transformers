...
"HTransformerEncoder",  # Building part of bigger (tested) model.
    "HTransformerDecoder",  # Building part of bigger (tested) model.
    "HTransformerDecoderWrapper", # Building part of bigger (tested) model.
